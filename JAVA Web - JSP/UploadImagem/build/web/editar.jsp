<%-- 
    Document   : editar
    Created on : 26/01/2020, 02:08:14
    Author     : Matheus
--%>
...
<html>
    ...
    <body>
        <h1>Editar Agente da Inovação</h1>
        <form action="editar_submit.jsp" method="post" enctype="multipart/form-data">
            
            <input type="hidden" name="id_agente" value="<%=request.getParameter("id_agente")%>" />
            
            <label>nome do Agente:</label></br>
            <input type="text" name="nome_agente" value="<%=request.getParameter("nome_agente")%>" /></br></br>
            
            <label>E-mail:</label></br>
            <input type="email" name="email_agente" value="<%=request.getParameter("email_agente")%>" /></br></br>
            
            <label>telefone:</label></br>
            <input type="text" name="telefone_agente" id="telefone" value="<%=request.getParameter("telefone_agente")%>" /></br></br>
            
            <label>Cidade:</label></br>
            <input type="text" name="cidade" value="<%=request.getParameter("cidade")%>" /></br></br>
            
            <label>Região:</label></br>
            <select name="regiao" value="<%=request.getParameter("regiao")%>">
                <option></option>
            ...
            <select name="unidade" value="<%=request.getParameter("unidade")%>">
                <option></option>
            ...
            <input type="file" name="foto" value="<%=request.getParameter("foto")%>" />
            </br></br>
